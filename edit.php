...
$stmts = $pdo->query("SELECT * FROM personal ");
...
<form method = "post">
            <div class="row">
              ...
              <div class="col-sm-8"><input type="text" name="name" value="<?= htmlentities($row['name']);?>"></div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
              <div class="col-sm-8"><input type="text" name="Email" value="<?= htmlentities($row['Email']);?>"></div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8"><input type="text" name="mobile" value="<?= htmlentities($row['mobile']);?>"></div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Occupation:</strong></div>
              <div class="col-sm-8"><input type="text" name="occupation" value="<?= htmlentities($row['occupation']);?>"></div>
            </div>
            <br>
